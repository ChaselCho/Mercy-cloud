...
package com.mercy.uac.service.impl;
...
import com.mercy.uac.mapper.SysUserMapper;
import com.mercy.uac.model.dto.UserDTO;
import com.mercy.uac.model.dto.UserInfo;
import com.mercy.uac.model.entity.SysDeptRelation;
import com.mercy.uac.model.entity.SysUser;
import com.mercy.uac.model.entity.SysUserRole;
import com.mercy.uac.service.SysDeptRelationService;
import com.mercy.uac.service.SysMenuService;
import com.mercy.uac.service.SysUserRoleService;
import com.mercy.uac.service.SysUserService;
import com.mercy.common.bean.interceptor.DataScope;
...
import com.mercy.common.vo.MenuVO;
import com.mercy.common.vo.SysRole;
import com.mercy.common.vo.UserVO;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    @Override
    public Page selectWithRolePage(BaseQuery query, UserVO userVO) {
     ...
     */
    @Override
    public ResultBean<Boolean> sendSmsCode(String mobile) {
        Object tempCode = redisTemplate.opsForValue().get(SecurityConstants.DEFAULT_CODE_KEY + mobile);
        if (tempCode != null) {
            log.error("用户:{}验证码未失效{}", mobile, tempCode);
            return new ResultBean<>(false, "验证码未失效，请失效后再次申请");
        }
        ...
        if (CollectionUtil.isEmpty(userList)) {
            ...
            return new ResultBean<>(false, "手机号不存在");
        }
...
//                ));
    ...
    public ResultBean<Boolean> updateUserInfo(UserDTO userDto, String username) {
