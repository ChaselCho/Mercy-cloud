...
package com.mercy.auth.fegin;

import com.mercy.auth.fegin.fallback.UserServiceFallbackImpl;
import com.mercy.common.vo.UserVO;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PathVariable;

@FeignClient(name = "mercy-upms-service", fallback = UserServiceFallbackImpl.class)
